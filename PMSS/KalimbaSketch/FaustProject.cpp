...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "FaustProject.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst1 = std::pow(0.001f, 1e+01f / fConst0);
		fConst2 = mydsp_faustpower2_f(fConst1);
		fConst3 = 44.1f / fConst0;
		fConst4 = 1.0f - fConst3;
		fConst5 = 1.0053097f / fConst0;
		fConst6 = 0.0f - 2.0f * fConst1;
		float fConst7 = std::pow(0.001f, 2.0f / fConst0);
		fConst8 = mydsp_faustpower2_f(fConst7);
		fConst9 = std::cos(20106.193f / fConst0) * (0.0f - 2.0f * fConst7);
		float fConst10 = std::pow(0.001f, 1.0f / fConst0);
		fConst11 = mydsp_faustpower2_f(fConst10);
		fConst12 = 0.12566371f / fConst0;
		fConst13 = 0.0f - 2.0f * fConst10;
		float fConst14 = std::pow(0.001f, 0.5f / fConst0);
		fConst15 = mydsp_faustpower2_f(fConst14);
		fConst16 = 2.8274336f / fConst0;
		fConst17 = 0.0f - 2.0f * fConst14;
		fConst18 = 11.938052f / fConst0;
		float fConst19 = std::pow(0.001f, 0.33333334f / fConst0);
		fConst20 = mydsp_faustpower2_f(fConst19);
		fConst21 = 6.2831855f / fConst0;
		fConst22 = 0.0f - 2.0f * fConst19;
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(1.1e+03f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("FaustProject");
		ui_interface->addHorizontalSlider("Freq", &fHslider0, FAUSTFLOAT(1.1e+03f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(0.1f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec0[0] = fTemp2 - (fConst6 * fRec0[1] * std::cos(fConst5 * fRec1[0]) + fConst2 * fRec0[2]);
			fRec2[0] = fTemp2 - (fConst9 * fRec2[1] + fConst8 * fRec2[2]);
			fRec3[0] = fTemp2 - (fConst13 * fRec3[1] * std::cos(fConst12 * fRec1[0]) + fConst11 * fRec3[2]);
			fRec4[0] = fTemp2 - (fConst17 * fRec4[1] * std::cos(fConst16 * fRec1[0]) + fConst15 * fRec4[2]);
			fRec5[0] = fTemp2 - (fConst13 * fRec5[1] * std::cos(fConst18 * fRec1[0]) + fConst11 * fRec5[2]);
			fRec6[0] = fTemp2 - (fConst22 * fRec6[1] * std::cos(fConst21 * fRec1[0]) + fConst20 * fRec6[2]);
			float fTemp3 = 0.16666667f * (0.15f * (fRec6[0] - fRec6[2]) + 0.095f * (fRec5[0] - fRec5[2]) + 0.1f * (fRec4[0] - fRec4[2] + (fRec3[0] - fRec3[2]) + (fRec2[0] - fRec2[2])) + fTemp2 * (fRec0[0] - fRec0[2]));
	...
	#define FAUST_FILE_NAME "FaustProject.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Freq", fHslider0, 1.1e+03f, 0.0f, 2e+03f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Freq, "Freq", fHslider0, 1.1e+03f, 0.0f, 2e+03f, 0.1f) \
...
FaustProject::FaustProject() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void FaustProject::updateImp(void)
{
#if MIDICTRL
...
void FaustProject::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void FaustProject::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float FaustProject::getParamValue(const std::string& path)
{
