function [pitchEstimate, freqVector, objFunction] = combFilterPitchEstimator(data, pitchBounds)
    nData = length(data);
    delayBounds = [max(1,ceil(1/pitchBounds(2))), min(nData-1, floor(1/pitchBounds(1)))];
